import java.util.*; import java.io.*; class temp{
double p;
String q,r;
}
class prog5
...
{
BufferedReader csv = new BufferedReader(new FileReader(new File("input5.csv")));
...
System.out.println("Enter weight(1.0 - 60.0) and shirt size(S,M,L) to find its class");
...
//probability for numeric = (1/(root(2*PI)*sd))exponential(- square(value-mean)/(2*square(sd))
